...
function newsletter_feature() { 
	// creating (registering) the custom type 
	register_post_type( 'featured_news', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Featured News', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('News Feature', 'bonestheme'), /* This is the individual type */
			'all_items' => __('All News Features', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Add Another', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Add New Feature', 'bonestheme'), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __('Edit Feature', 'bonestheme'), /* Edit Display Title */
			'new_item' => __('New Feature', 'bonestheme'), /* New Display Title */
			'view_item' => __('View Feature', 'bonestheme'), /* View Display Title */
			'search_items' => __('Search Featured News', 'bonestheme'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.', 'bonestheme'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'bonestheme'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Featured News is in the most recognizable part of your newsletter.', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/newsletter.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'featured_news', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'featured_news', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('category', 'featured_news');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'featured_news');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'newsletter_feature');
