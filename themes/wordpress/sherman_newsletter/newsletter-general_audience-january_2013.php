...
<head>
	...
	<title>Happenings at the Alvin Sherman Library for November 2012</title>
	<style type="text/css">
	/* ==================
	 * Reset
	 * ================== */
		...
		#backgroundTable {margin:0; padding:0; width:100% !important; line-height: 100% !important; background-image: url('<?php echo get_template_directory_uri(); ?>/library/images/background.png');}
		#contentTable {background-image: url('<?php echo get_template_directory_uri(); ?>/library/images/white-background.png'); border-top: 3px solid #333333;}	
	/* ==================
	 * Media
	 * ================== */
...
-->	<table cellpadding="0" cellspacing="0" boder="0" id="backgroundTable">
	<tr>
		...
		<!-- Exhibits
		======================
		--> <?php query_posts(array('post_type' => 'newsletter_exhibits', 'category__and' => array( $issue ) )); ?>
		    <?php if ( have_posts()) : while ( have_posts()) : the_post(); ?>
		    	<tr>
	    ...
	    --> <tr>
	    	...
	    	<?php query_posts(array('post_type' => 'featured_news', 'category__and' => array( $issue, 10) )); ?>
		    <?php if ( have_posts()) : while ( have_posts()) : the_post(); ?>
			<tr>
	...
	<!-- Adult Events
	======================
	-->	<?php $query = query_posts(array('post_type' => 'newsletter_events', 'category__and' => array( $issue, 10) )); ?>
	...
	--> <table id="contentTable" cellpadding="0" cellspacing="0" border="0" align="center">
		<tr>
	    	<td colspan="3" width="600px" valign="top">
	    		<br />
	    		<img src="http://sherman.library.nova.edu/sites/newsletter/files/2012/11/divider-teens.jpg" alt="" class="image_fix" />
	    	</td>
	    </tr>
    	
    	<?php query_posts(array('post_type' => 'featured_news', 'category__and' => array( $issue, 9 ) )); ?>
	    <?php if ( have_posts()) : while ( have_posts()) : the_post(); ?>
		<tr>
			<td width="144px" height="200px" valign="top">
	...
	<!-- Teen Events
	======================
	-->	<?php $query = query_posts(array('post_type' => 'newsletter_events', 'category__and' => array( $issue, 9) )); ?>
	...
	--> <table id="contentTable" cellpadding="0" cellspacing="0" border="0" align="center">
    	...
    	<?php query_posts(array('post_type' => 'featured_news', 'category__and' => array( $issue, 8 ) )); ?>
	    <?php if ( have_posts()) : while ( have_posts()) : the_post(); ?>
		<tr>
			<td width="144px" height="200px" valign="top">
	...
	<!-- Children Events
	======================
	-->	<?php $query = query_posts(array('post_type' => 'newsletter_events', 'category__and' => array( $issue, 8) )); ?>
	...
	======================
	-->	<?php $query = query_posts(array('post_type' => 'newsletter_events', 'category__and' => array( $issue, 11) )); ?>
