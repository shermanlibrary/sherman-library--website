...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'sherman-stylesheet', 'http://sherman.library.nova.edu/cdn/styles/css/polar.css', array(), '0.1.3', 'all' );

    // ie-only style sheet
    wp_register_style( 'bones-ie-only', 'http://sherman.library.nova.edu/cdn/styles/css/polar-ie.css', array(), '' );
    ...
    wp_register_script( 'bones-js', 'http://sherman.library.nova.edu/sites/wp-content/themes/shermanlibrary/library/js/scripts.js', array( 'jquery' ), '', true );
    
    // enqueue styles and scripts
    wp_enqueue_script( 'bones-modernizr' ); 
    wp_enqueue_style( 'sherman-stylesheet' ); 
