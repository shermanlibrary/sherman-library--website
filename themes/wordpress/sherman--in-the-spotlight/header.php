		...
		-->	<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<a class="logo" id="logo" href="<?php bloginfo('url');?>" title="<?php bloginfo('title'); ?>">
						the<span class="main-accent">spotlight</span>
						<!--<span class="tagline">alvin sherman library</span>-->
					</a>
					...
					--> <ul>
							...
							<li class="has-subnav primary">
								...
								<label class="label" for="primary-menu">Spotlight</label>
					...
					--> <li class="has-subnav secondary">
							...
							<label class="label" for="secondary-menu">
								<?php if ( !is_front_page() ) : ?><?php echo library_academy_menu('secondary', 'label'); ?><?php else : ?>Everything<?php endif; ?></label>
					...
					<!--<div class="menu badges social inline">
						<a class="icon-twitter" title="Twitter" href="http://twitter.com/alvinshermanlib/" target="new">
							<span class="hide-text">Twitter</span>
						</a>
						<a class="icon-facebook-2" title="Facebook" href="https://www.facebook.com/AlvinShermanLibrary" target="new">
