...
class orgSeries {
	...
	function register_scripts() {
		wp_register_script('inline-edit-series',get_template_directory_uri().'/library/bundles/series/js/inline-series.js', array('jquery'));  
		wp_register_script( 'ajaxseries', get_template_directory_uri().'/library/bundles/series/js/series.js', array('jquery', 'jquery-ui-core', 'jquery-color'), '20120910' );
		...
		wp_register_script( 'orgseries_options', get_template_directory_uri().'/library/bundles/series/js/orgseries_options.js', array('jquery', 'thickbox'));
	}
	...
	function register_taxonomy() {
		...
		// AcademyHack: Extend the "series" functionality to custom post types here.
		$object_type = apply_filters('orgseries_posttype_support', array('post','academy_video'));
		$capabilities = array(
