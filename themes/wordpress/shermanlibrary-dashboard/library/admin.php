...
/*if ( !current_user_can('administrator') ) {
	...
	global $menu;
	    $restricted = array(__('Posts'), __('Pages'), __('Users'), __('Comments'), __('Plugins'), __('Appearance'),  __('Links'),  __('Feedback'),  __('Tools'),  __('Links'),  __('Settings'),  'SEO');
	    end ($menu);
	    while (prev($menu)){
...
function bones_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed for the  <a href="http://nova.edu/library/main" target="_blank">Alvin Sherman Library</a></span>.';
}
