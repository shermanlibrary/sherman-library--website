...
function orgseries_load_custom_column_actions() {
	...
	$posttypes = apply_filters('orgseries_posttype_support', array('post', 'academy_video') );
	foreach ( $posttypes as $posttype ) {
		...
		$action_ref = ( $posttype == 'academy_video' ) ? 'manage_academy_custom_column' : $action_ref;
...
function orgseries_load_custom_column_filters() {
	...
	foreach ( $posttypes as $posttype ) {
		...
		$filter_ref = ( $posttype == 'academy_video' ) ? 'manage_pages_columns' : 'manage_posts_columns';
...
function orgSeries_custom_column_filter($defaults) {
	global $orgseries;
	$post_types = apply_filters( 'orgseries_posttype_support', array('post', 'academy_video') );
