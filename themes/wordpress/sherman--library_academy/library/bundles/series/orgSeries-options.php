		...
		<div id="side-info-column" class="inner-sidebar">
			<div id="side-sortables" class="meta-box-sortables ui-sortable">
				...
				<div id="plugin-info-div" class="postbox">
					<h3 class="hndle"><span>Library Academy</span></h3>
				<div class="inside">
					<p>This Library Academy branded fork of Organize Series is an
						excellent example of what libraries do without an expendable
						budget. It is based off the free open-source version of 
						Organize Series. This plugin itself has been extended for profit,
						certain functions that we needed would cost $20 - so instead we
						took the liberty of extending Organize Series ourselves.</p>					
				</div>
			</div>
